...
class SampleWithGlobalAndTFF extends StatefulWidget {
  @override
  _SampleWithGlobalAndTFFState createState() => _SampleWithGlobalAndTFFState();
}

class _SampleWithGlobalAndTFFState extends State<SampleWithGlobalAndTFF> {
        ...
        body: Padding(
          ...
          child: Column(
            children: [
              ...
              SizedBox(height: 20), // sử dụng SizedBox để tạo một khoảng space giữa Button và Form
              FlatButton(
                child: Text('Submit'),
                color: Colors.pink,
