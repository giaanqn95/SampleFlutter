...
class SampleWithBlocPattern extends StatefulWidget {
  @override
  _SampleWithBlocPatternState createState() => _SampleWithBlocPatternState();
}

class _SampleWithBlocPatternState extends State<SampleWithBlocPattern> {
  final bloc = MyBloc();
